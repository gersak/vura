...
(def holidays
 ...
 "03-08 12:00" {"note" "Women", :name (partial n/get-name "03-08")},
 "2021-10-07" {:name {:en "National Day", :zh "国庆节"}},
 "2021-05-03" {:name (partial n/get-name "05-01")},
 "2021-02-15" {:name {:en "Spring Festival", :zh "春节"}},
 "08-01 12:00"
 {"note" "Military personnel in active service",
  :name {:en "Army Day", :zh "建军节"}},
 "2021-05-05" {:name (partial n/get-name "05-01")},
 "2021-05-04" {:name (partial n/get-name "05-01")},
 ...
 "2021-01-02" {:name (partial n/get-name "01-01")},
 "2021-05-02"
 ...
 "2021-01-03" {:name (partial n/get-name "01-01")},
