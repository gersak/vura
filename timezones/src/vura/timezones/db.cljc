  ...
  (merge-with
   ...
   {:zones
    {"Asia/Rangoon" "Asia/Yangon",
     ...
     "Asia/Sakhalin"
     {:offset 39600000, :rule "-", :format "+11", :from 1456797600000},
     "America/Santarem"
     {:offset -10800000, :rule "-", :format "-03", :from 1212278400000},
     ...
     "Asia/Chita"
     {:offset 32400000, :rule "-", :format "+09", :from 1456797600000},
     "Universal" "Etc/UTC",
     ...
     {:offset -10800000, :rule "-", :format "-03", :from 1254355200000},
     "America/St_Johns"
     {:offset -12600000,
      :rule "Canada",
      :format "N%sT",
     ...
     "Asia/Aqtobe"
     {:offset 18000000, :rule "-", :format "+05", :from 1096596000000},
     "Antarctica/Macquarie"
     {:offset 39600000, :rule "-", :format "+11", :from 1270090800000},
     "Asia/Seoul"
     {:offset 32400000, :rule "ROK", :format "K%sT", :from -265680000000},
     "Chile/EasterIsland" "Pacific/Easter",
     "US/Hawaii" "Pacific/Honolulu",
     "America/Punta_Arenas"
     {:offset -10800000, :rule "-", :format "-03", :from 1480550400000},
     "Indian/Christmas"
     {:offset 25200000, :rule "-", :format "+07", :from -2364076800000},
     "Atlantic/Madeira"
     {:offset 0, :rule "EU", :format "WE%sT", :from 431226000000},
     "Asia/Barnaul"
     {:offset 25200000, :rule "-", :format "+07", :from 1456797600000},
     "Asia/Colombo"
     {:offset 19800000, :rule "-", :format "+0530", :from 1143851400000},
     "America/Argentina/Mendoza"
     {:offset -10800000, :rule "-", :format "-03", :from 1222819200000},
     "Asia/Novokuznetsk"
     {:offset 25200000, :rule "-", :format "+07", :from 1298944800000},
     ...
     "Pacific/Pohnpei"
     {:offset 39600000, :rule "-", :format "+11", :from -770601600000},
     "Pacific/Norfolk"
     {:offset 39600000,
      :rule "AN",
      :format "+11/+12",
     ...
     "Atlantic/Stanley"
     {:offset -10800000, :rule "-", :format "-03", :from 1283306400000},
     ...
     "Pacific/Chuuk"
     {:offset 36000000, :rule "-", :format "+10", :from -770601600000},
     ...
     {:offset 7200000,
      ...
      :from 915148800000},
     "Asia/Kuching"
     {:offset 28800000, :rule "-", :format "+08", :from -767923200000},
     "Pacific/Tahiti"
     ...
     "Asia/Vladivostok"
     {:offset 36000000, :rule "-", :format "+10", :from 1412128800000},
     "Europe/Oslo"
     {:offset 3600000, :rule "EU", :format "CE%sT", :from 315532800000},
     ...
     {:offset -21600000,
      ...
      :from -1546300800000},
     "America/Porto_Velho"
     {:offset -14400000, :rule "-", :format "-04", :from 589075200000},
     ...
     "Pacific/Enderbury"
     {:offset 46800000, :rule "-", :format "+13", :from 786240000000},
     ...
     {:offset -32400000, :rule "US", :format "AK%sT", :from 436492800000},
     "America/Creston"
     {:offset -25200000, :rule "-", :format "MST", :from -1627948800000},
     ...
     {:offset 7200000, :rule "EU", :format "EE%sT", :from 852076800000},
     "Asia/Khandyga"
     {:offset 32400000, :rule "-", :format "+09", :from 1412128800000},
     "Asia/Kolkata"
     ...
     "Asia/Dushanbe"
     {:offset 18000000, :rule "-", :format "+05", :from 683690400000},
     "Asia/Choibalsan"
     {:offset 28800000,
      :rule "Mongol",
      :format "+08/+09",
     ...
     "Asia/Srednekolymsk"
     {:offset 39600000, :rule "-", :format "+11", :from 1412128800000},
     "America/Recife"
     {:offset -10800000, :rule "-", :format "-03", :from 1033430400000},
     "Europe/Belgrade"
     ...
     "Asia/Yekaterinburg"
     {:offset 18000000, :rule "-", :format "+05", :from 1412128800000},
     "America/Belize"
     {:offset -21600000,
      :rule "Belize",
      :format "%s",
     ...
     "Asia/Kamchatka"
     {:offset 43200000, :rule "-", :format "+12", :from 1298944800000},
     "Asia/Qostanay"
     {:offset 21600000, :rule "-", :format "+06", :from 1096596000000},
     ...
     "Etc/UCT" "Etc/UTC",
     "Pacific/Kwajalein"
     {:offset 43200000, :rule "-", :format "+12", :from 744249600000},
     "Asia/Yangon"
     {:offset 23400000, :rule "-", :format "+0630", :from -778550400000},
     "Mexico/BajaSur" "America/Mazatlan",
     "Canada/Pacific" "America/Vancouver",
     "America/Tortola" "America/Port_of_Spain",
     "Japan" "Asia/Tokyo",
     "Europe/Volgograd"
     {:offset 14400000, :rule "-", :format "+04", :from 1538359200000},
     "America/Inuvik"
     {:offset -25200000,
      :rule "Canada",
      :format "M%sT",
     ...
     "Europe/Astrakhan"
     {:offset 14400000, :rule "-", :format "+04", :from 1456797600000},
     "Europe/Prague"
     ...
     {:offset 21600000, :rule "-", :format "+06", :from 1096596000000},
     "Asia/Bishkek"
     {:offset 21600000, :rule "-", :format "+06", :from 1122854400000},
     ...
     {:offset -32400000,
      ...
      :from 1546308000000},
     "America/Boa_Vista"
     {:offset -14400000, :rule "-", :format "-04", :from 970358400000},
     "Pacific/Nauru"
     {:offset 43200000, :rule "-", :format "+12", :from 286682400000},
     "Asia/Brunei"
     {:offset 28800000, :rule "-", :format "+08", :from -1167609600000},
     "Pacific/Palau"
     {:offset 32400000, :rule "-", :format "+09", :from -2177452800000},
     "Asia/Dili"
     {:offset 32400000, :rule "-", :format "+09", :from 967766400000},
     ...
     {:offset -18000000, :rule "US", :format "E%sT", :from 1136073600000},
     "Atlantic/Reykjavik"
     {:offset 0, :rule "-", :format "GMT", :from -55292400000},
     "Iran" "Asia/Tehran",
     ...
     {:offset 3600000, :rule "EU", :format "CE%sT", :from 315532800000},
     "Asia/Novosibirsk"
     {:offset 25200000, :rule "-", :format "+07", :from 1467338400000},
     "Europe/Monaco"
     {:offset 3600000, :rule "EU", :format "CE%sT", :from 220924800000},
     ...
     {:offset -18000000,
      ...
      :from 126230400000},
     "America/Bahia"
     {:offset -10800000, :rule "-", :format "-03", :from 1349049600000},
     "Pacific/Majuro"
     {:offset 43200000, :rule "-", :format "+12", :from -7948800000},
     "Etc/GMT+9" {:offset -32400000, :rule "-", :format "-09", :from nil},
     "Asia/Tomsk"
     {:offset 25200000, :rule "-", :format "+07", :from 1462068000000},
     "Africa/Mbabane" "Africa/Johannesburg",
     "Pacific/Fakaofo"
     {:offset 46800000, :rule "-", :format "+13", :from 1322697600000},
     ...
     "Europe/Istanbul"
     {:offset 10800000, :rule "-", :format "+03", :from 1472688000000},
     ...
     {:offset 7200000,
      ...
      :from -1640995200000},
     "Asia/Magadan"
     {:offset 39600000, :rule "-", :format "+11", :from 1459476000000},
     "UTC" "Etc/UTC",
     ...
     "America/Belem"
     {:offset -10800000, :rule "-", :format "-03", :from 589075200000},
     "Europe/Lisbon"
     ...
     "Europe/Minsk"
     {:offset 10800000, :rule "-", :format "+03", :from 1298944800000},
     ...
     {:offset 3600000, :rule "EU", :format "CE%sT", :from 315532800000},
     "Asia/Krasnoyarsk"
     {:offset 25200000, :rule "-", :format "+07", :from 1412128800000},
     "America/Glace_Bay"
     {:offset -14400000,
      :rule "Canada",
      :format "A%sT",
     ...
     "Pacific/Pitcairn"
     {:offset -28800000, :rule "-", :format "-08", :from 891388800000},
     ...
     {:offset 39600000, :rule "-", :format "+11", :from 1417399200000},
     ...
     "America/Atikokan"
     {:offset -18000000, :rule "-", :format "EST", :from -767916000000},
     "America/Detroit"
     ...
     "Asia/Ashgabat"
     {:offset 18000000, :rule "-", :format "+05", :from 694231200000},
     "America/Edmonton"
     {:offset -25200000,
      :rule "Canada",
      :format "M%sT",
     ...
     "Europe/Saratov"
     {:offset 14400000, :rule "-", :format "+04", :from 1480557600000},
     "Greenwich" "Etc/GMT",
     ...
     "Africa/Juba"
     {:offset 10800000, :rule "-", :format "EAT", :from 946728000000},
     ...
     "America/Rio_Branco"
     {:offset -18000000, :rule "-", :format "-05", :from 1383264000000},
     ...
     {:offset 43200000,
      ...
      :from -1709942400000},
     "Asia/Omsk"
     {:offset 21600000, :rule "-", :format "+06", :from 1412128800000},
     ...
     "Asia/Irkutsk"
     {:offset 28800000, :rule "-", :format "+08", :from 1412128800000},
     "Antarctica/Palmer"
     {:offset -10800000, :rule "-", :format "-03", :from 1480550400000},
     ...
     {:offset 14400000,
      ...
      :from -1988150400000},
     "Europe/Samara"
     {:offset 14400000, :rule "-", :format "+04", :from 1298944800000},
     "America/Eirunepe"
     {:offset -18000000, :rule "-", :format "-05", :from 1383264000000},
     "America/Fort_Nelson"
     ...
     "Pacific/Kiritimati"
     {:offset 50400000, :rule "-", :format "+14", :from 786240000000},
     "PRC" "Asia/Shanghai",
     "America/Argentina/ComodRivadavia" "America/Argentina/Catamarca",
     "Asia/Qyzylorda"
     {:offset 18000000, :rule "-", :format "+05", :from 1543622400000},
     ...
     "Europe/Kirov"
     {:offset 10800000, :rule "-", :format "+03", :from 1412128800000},
     ...
     "Atlantic/Cape_Verde"
     {:offset -3600000, :rule "-", :format "-01", :from 184039200000},
     "Australia/Darwin"
     {:offset 34200000,
      :rule "Aus",
      :format "AC%sT",
     ...
     "Asia/Ho_Chi_Minh"
     {:offset 25200000, :rule "-", :format "+07", :from 170812800000},
     ...
     "America/Manaus"
     {:offset -14400000, :rule "-", :format "-04", :from 778377600000},
